...
#### 10.7. Strings
           ...
           - One key idea here is that everything in the machine is just a number. The meaning and interpretation
           of those bytes as the string "Hello" is created by the %s format specifier, which tells the display to 
           present the ASCII interpretation of the bytes to the user instead of the numeric values.
